...
class EntitySchemaBuilder[C](val aClass : Class[C], isTable : Boolean) {
  ...
  def property(name : String, builder: PropertyBuilder[C] => PropertyBuilder[C]) : EntitySchemaBuilder[C] = {
    val propertyBuilder = new PropertyBuilder[C](name, aClass, isTable)
  ...
  def property(name : String) : EntitySchemaBuilder[C] = {
    val property = new PropertyBuilder[C](name, aClass, isTable)
