package com.anjunar.technologyspeaks.jaxrs;
...
import com.fasterxml.jackson.jakarta.rs.json.PackageVersion;
 ...
 */
@Provider
@Consumes({MediaType.APPLICATION_JSON, "text/json", MediaType.WILDCARD}) // NOTE: required to support "non-standard" JSON variants
@Produces({MediaType.APPLICATION_JSON, "text/json", MediaType.WILDCARD})
public class JacksonJsonProvider
        extends ProviderBase<com.fasterxml.jackson.jakarta.rs.json.JacksonJsonProvider,
        ObjectMapper,
